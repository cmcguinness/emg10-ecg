...
from environment import summary as env_summary  # noqa: E402
...
def render(path, a: Analysis, title: str, device_hr: int | None = None,
    ...
    fig.text(margin / fig_w, 3 / fig_h, f"Generated by {env_summary()}  |  results may differ with other versions",
             fontsize=5.5, color="0.5", va="bottom")
